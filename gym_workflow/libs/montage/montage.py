...
class Montage:
    ...
    @staticmethod
    def gen_cs_wall_time(cs):
        data = {
            0.5: {
                1: lambda: random.randrange(1025.0, 4716.0, 1),
                2: lambda: random.randrange(702.0, 848.0, 1),
                3: lambda: random.randrange(632.0, 696.0, 1),
                4: lambda: random.randrange(615.0, 720.0, 1),
                5: lambda: random.randrange(655.0, 720.0, 1),
                6: lambda: random.randrange(656.0, 930.0, 1),
                7: lambda: random.randrange(691.0, 737.0, 1),
                8: lambda: random.randrange(696.0, 761.0, 1),
                9: lambda: random.randrange(708.0, 779.0, 1),
                10: lambda: random.randrange(712.0, 802.0, 1),
                11: lambda: random.randrange(754.0, 821.0, 1),
                12: lambda: random.randrange(781.0, 844.0, 1),
                13: lambda: random.randrange(820.0, 875.0, 1),
                14: lambda: random.randrange(851.0, 988.0, 1),
                15: lambda: random.randrange(859.0, 908.0, 1),
                16: lambda: random.randrange(877.0, 926.0, 1),
                17: lambda: random.randrange(912.0, 960.0, 1),
                18: lambda: random.randrange(934.0, 1194.0, 1),
                19: lambda: random.randrange(963.0, 1021.0, 1),
                20: lambda: random.randrange(997.0, 1047.0, 1),
                21: lambda: random.randrange(1015.0, 1083.0, 1),
                22: lambda: random.randrange(1029.0, 1098.0, 1),
                23: lambda: random.randrange(1066.0, 1130.0, 1),
                24: lambda: random.randrange(1073.0, 1130.0, 1),
                25: lambda: random.randrange(1115.0, 1211.0, 1),
                26: lambda: random.randrange(1151.0, 1191.0, 1),
                27: lambda: random.randrange(1168.0, 1237.0, 1),
                28: lambda: random.randrange(1189.0, 1231.0, 1),
                29: lambda: random.randrange(1224.0, 1278.0, 1),
                30: lambda: random.randrange(1258.0, 1314.0, 1),
            }, }
        return data[0.5][cs]()

    @staticmethod
    def gen_cn_wall_time(cn):
        data = {
            0.5: {
                1: lambda: random.randrange(1669.0, 1713.0, 1),
                2: lambda: random.randrange(1037.0, 1094.0, 1),
                3: lambda: random.randrange(873.0, 948.0, 1),
                4: lambda: random.randrange(733.0, 785.0, 1),
                5: lambda: random.randrange(689.0, 733.0, 1),
                6: lambda: random.randrange(667.0, 992.0, 1),
                7: lambda: random.randrange(669.0, 706.0, 1),
                8: lambda: random.randrange(608.0, 919.0, 1),
                9: lambda: random.randrange(584.0, 631.0, 1),
                10: lambda: random.randrange(582.0, 623.0, 1),
                11: lambda: random.randrange(509.0, 557.0, 1),
                12: lambda: random.randrange(507.0, 552.0, 1),
                13: lambda: random.randrange(516.0, 553.0, 1),
                14: lambda: random.randrange(531.0, 583.0, 1),
                15: lambda: random.randrange(515.0, 544.0, 1),
                16: lambda: random.randrange(542.0, 600.0, 1),
                17: lambda: random.randrange(545.0, 605.0, 1),
                18: lambda: random.randrange(540.0, 635.0, 1),
                19: lambda: random.randrange(537.0, 573.0, 1),
                20: lambda: random.randrange(529.0, 580.0, 1),
                21: lambda: random.randrange(528.0, 564.0, 1),
                22: lambda: random.randrange(507.0, 554.0, 1),
                23: lambda: random.randrange(532.0, 561.0, 1),
                24: lambda: random.randrange(511.0, 581.0, 1),
                25: lambda: random.randrange(531.0, 769.0, 1),
                26: lambda: random.randrange(497.0, 579.0, 1),
                27: lambda: random.randrange(502.0, 543.0, 1),
                28: lambda: random.randrange(510.0, 539.0, 1),
                29: lambda: random.randrange(509.0, 564.0, 1),
                30: lambda: random.randrange(518.0, 551.0, 1),
                31: lambda: random.randrange(511.0, 545.0, 1),
            }, }
        return data[0.5][cn]()
    ...
    def gen_static_makespan(cp):
        ...
        cs_degree = {
            ...
            "real": {
                ...
                8: 726.7666666666667,
                9: 742.0,
                10: 761.7666666666667,
                11: 790.5,
                12: 815.5333333333333,
                13: 849.4333333333333,
                14: 875.8333333333334,
                15: 878.9333333333333,
                16: 902.6333333333333,
                17: 932.3333333333334,
                18: 973.8666666666667,
                19: 995.7,
                20: 1022.0333333333333,
                21: 1044.1666666666667,
                22: 1055.5,
                23: 1087.9666666666667,
                24: 1105.1333333333334,
                25: 1138.6,
                26: 1169.7333333333333,
                27: 1185.7,
                28: 1213.8,
                29: 1246.1333333333334,
                30: 1275.0333333333333
            }
        }
        return cs_degree["fake"][cp]
