...
if __name__ == '__main__':
    ...
    Q, stats, records = TD.q_learning(
        ...
        training_episode=0, log_file="exp2-training-0-epi-{}-vm-10.csv".format(episodes),
    )
    ...
    plt.v1_plot_action_value(sQ, title="Experiment 2: Q-Value Overview - %s episodes" % episodes)
