...
if __name__ == '__main__':
    ...
    Q, stats, records = TD.q_learning(
        ...
        training_episode=1, log_file="v2-training-epi-{}-vm-10.csv".format(episodes),
    )
    ...
    plt.v1_plot_action_value(sQ, title="Experiment 2: Action Values Overview - %s episodes" % episodes)
